...
class StoreAttendanceRecordRequest extends FormRequest
{
    ...
    {
        return auth()->user()?->can('create', \App\Models\AttendanceRecord::class) ?? false;
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'date' => ['required', 'date', 'unique:attendance_records,date,NULL,id,employee_id,' . ($this->employee_id ?? '')],
