...
export default function PortalSpacesShow({ space }: Props) {
    return (
        <PortalLayout title="Detalhe do Espaco" subtitle={space.name} headerActions={<Link href={route('portal.space-reservations.create')} className="flex w-full items-center justify-center rounded-xl bg-amber-600 px-4 py-3 text-sm font-semibold text-white lg:inline-flex lg:w-auto lg:py-2">Pedir reserva</Link>}>
